...
Use `@earendil-works/pi-agent-core` as the sole SDK-level runtime dependency. Hide it behind HyperTest's `AgentRuntime` interface and confine imports to `src/runtime/pi/**`.
